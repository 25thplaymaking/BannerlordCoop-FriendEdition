...
public class ClientLogic : IClientLogic
{
    ...
    private IReadOnlyDictionary<Type, Func<IClientState>> CreateStateFactories() =>
        ...
        {
            [typeof(MainMenuState)] = () => new MainMenuState(this, context.MessageBroker, context.Network, context.GameInterface, context.GameStateInterface, context.LoadingInterface, context.CoopFinalizer),
            [typeof(ValidateModuleState)] = () => new ValidateModuleState(this, context.MessageBroker, context.Network, context.ControllerIdProvider, context.CoopFinalizer, context.GameStateInterface, context.LoadingInterface, context.ModuleInfoProvider, context.WorkshopManifestProvider, context.ModConfigAuthority),
