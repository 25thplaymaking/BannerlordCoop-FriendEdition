...
/// <summary>
/// The two active combat mods through the same gates as Diplomacy. Each file is the whole cost of
/// covering a mod once its <see cref="IWorkshopModule"/> exists — derived classes replacing
