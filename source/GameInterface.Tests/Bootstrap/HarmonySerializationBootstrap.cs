...
/// Workshop module isolation tests (ImprovedGarrisons, Fourberie, Diplomacy, Combat). Forcing the
/// System.Text.Json fallback removes that indirection. The switch must be set before
/// <c>HarmonySharedState</c>'s static constructor first runs, which a module initializer guarantees:
/// it executes before any type in this module is used, ahead of every test class' static state.
/// </remarks>
