...
internal static class VillageNeedsCraftingMaterialsQuestType
{
    ...
    private static void RejectAcceptanceCore(Hero owner)
    {
        ...
        // Only roll back if no owner is recorded yet - once an owner is recorded, a legitimate mirror already
        // superseded this peer's own optimistic accept and must be left alone.
